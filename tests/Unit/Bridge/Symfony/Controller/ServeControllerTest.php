...
namespace Tattali\PresignedUrl\Tests\Unit\Bridge\Symfony\Controller;
...
final class ServeControllerTest extends TestCase
{
    ...
    #[Test]
    public function it_passes_request_headers_to_file_server(): void
    {
        $fileResponse = new FileResponse(200, [], 'content');
        ...
        $controller = new ServeController($fileServer);
        $controller($request, 'bucket', 'file.txt');
    }
